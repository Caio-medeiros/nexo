...
/* ═══════════════════════════════════════════════════════════════════════════
   ── FIM DO NÚCLEO PARTILHADO · INÍCIO DA LÓGICA ESPECÍFICA DESTE MENU ──
   Cada menu é autossuficiente: o antigo js/menu-engine.js foi re-integrado
   aqui para não depender de um ficheiro externo que possa falhar a carregar.
   ═══════════════════════════════════════════════════════════════════════════ */
...
// Fallback ao INSERT directo se a RPC falhar/não existir (pré-044).
