...
const CONFIG = {
  ...
  wines: [
    ...
    { name: "Margarita",                         country: "México",   region: "Tequila",  type: "margarita", grape: "Tequila",   abv: "13%",  volume: "25cl", price: "6,50€",  photo: null, desc: "Clássica, spicy, manga ou maracujá." },
    { name: "Mezcal Margarita",                  country: "México",   region: "Mezcal",   type: "margarita", grape: "Mezcal",    abv: "13%",  volume: "25cl", price: "7,00€",  photo: null, desc: "Clássica, spicy, manga ou maracujá — com o toque fumado do mezcal." },
    { name: "Vodka Sour Tamarindo",              country: "México",   region: "—",        type: "cocktail",  grape: "Vodka",     abv: "12%",  volume: "25cl", price: "6,00€",  photo: null, desc: "Vodka, tamarindo e um final ácido irresistível." },
    { name: "Charro Negro",                      country: "México",   region: "—",        type: "cocktail",  grape: "Tequila",   abv: "10%",  volume: "30cl", price: "5,00€",  photo: null, desc: "Coca-Cola com sumo de lima, tequila ou vodka." },
    { name: "Corona Chrus",                      country: "México",   region: "—",        type: "cocktail",  grape: "Tequila",   abv: "8%",   volume: "33cl", price: "5,50€",  photo: null, desc: "Calipo de lima-limão, coronita, tequila e gelo picado." },
    { name: "Merengue",                          country: "México",   region: "—",        type: "cocktail",  grape: "Cerveja",   abv: "4%",   volume: "33cl", price: "3,00€",  photo: null, desc: "Sprite, groselha e cerveja Corona." },
    { name: "Cerveja Coronita",                  country: "México",   region: "—",        type: "cerveja",   grape: "Corona",    abv: "4,5%", volume: "21cl", price: "2,50€",  photo: null, desc: "A mini Corona, gelada." },
    { name: "Cerveja Nacional",                  country: "Portugal", region: "—",        type: "cerveja",   grape: "Nacional",  abv: "5%",   volume: "20cl", price: "2,00€",  photo: null, desc: "Imperial portuguesa fresca." },
    { name: "Shot de Tequila",                   country: "México",   region: "—",        type: "shot",      grape: "Tequila",   abv: "38%",  volume: "4cl",  price: "2,00€",  photo: null, desc: "Puro, com sal e lima." },
    { name: "Shot de Mezcal",                    country: "México",   region: "—",        type: "shot",      grape: "Mezcal",    abv: "40%",  volume: "4cl",  price: "2,50€",  photo: null, desc: "Fumado, com sal de verme." },
    { name: "Shot de Vodka Tamarindo",           country: "México",   region: "—",        type: "shot",      grape: "Vodka",     abv: "30%",  volume: "4cl",  price: "2,00€",  photo: null, desc: "Doce-ácido, com kick de tamarindo." },
    { name: "Sangria Branca (1L)",               country: "Portugal", region: "—",        type: "sangria",   grape: "Vinho",     abv: "9%",   volume: "1L",   price: "12,00€", photo: null, desc: "Para partilhar. Vinho branco e fruta fresca." },
    { name: "Sangria Espumante c/ Morango (1L)", country: "Portugal", region: "—",        type: "sangria",   grape: "Espumante", abv: "10%",  volume: "1L",   price: "15,00€", photo: null, desc: "Espumante e morango — festa numa jarra." },
    { name: "Jarro de Margarita (1,5L)",         country: "México",   region: "Tequila",  type: "margarita", grape: "Tequila",   abv: "13%",  volume: "1,5L", price: "25,00€", photo: null, desc: "Para o grupo. Margarita clássica em jarro." },

    /* ── BEBIDAS COM PINTA · sem álcool ── */
    { name: "Água Fresca",       country: "México",   region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "40cl", price: "2,50€", photo: null, desc: "Ananás, água de coco, lima, açúcar e gelo." },
    { name: "Água de Jamaica",   country: "México",   region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "40cl", price: "2,00€", photo: null, desc: "Infusão de hibisco, refrescante e ligeiramente ácida." },
    { name: "Monaco",            country: "Portugal", region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "33cl", price: "2,50€", photo: null, desc: "Groselha e Sprite." },
    { name: "Limonada de Coco",  country: "México",   region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "40cl", price: "3,50€", photo: null, desc: "Leite de coco, leite condensado, sumo de lima e gelo picado." },
    { name: "Limonada Tropical", country: "México",   region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "40cl", price: "2,50€", photo: null, desc: "De maracujá, manga ou frutos vermelhos." },
    { name: "Limonada",          country: "México",   region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "40cl", price: "2,00€", photo: null, desc: "Fresca, feita na hora." },
    { name: "Água",              country: "Portugal", region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "50cl", price: "1,50€", photo: null, desc: "Água natural sem gás." },
    { name: "Água com Gás",      country: "Portugal", region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "50cl", price: "1,50€", photo: null, desc: "Água mineral com gás." },
    { name: "Ice Tea",           country: "Portugal", region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "33cl", price: "1,50€", photo: null, desc: "Gelado, pêssego ou limão." },
    { name: "Refrigerante",      country: "—",        region: "—", type: "sem-alcool", grape: "Sem álcool", abv: "0%", volume: "33cl", price: "2,50€", photo: null, desc: "Coca-Cola, Coca-Cola Zero, Sprite ou Fanta." }
  ],
